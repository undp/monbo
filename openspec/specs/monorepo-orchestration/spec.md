...
Define how the repository root drives per-package commands without adopting a workspace manager:
each package keeps its own tooling and lockfile, and the root only delegates.
